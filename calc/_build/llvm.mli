...
(* exemples:
   ...
   let putchar, genv = declare_extern genv "@putchar" (Int 32) [Int 32]
   let printf, genv = declare_extern genv "@printf" (Int 32) ~var_args:true [Ptr (Int 8)]
*)
...
(* environnement local pour compiler du code, créé par [start_function] et [start_init_code]
   ...
   let env = start_function genv "fib" ["x"] fib in
   ... code pour émettre le corps de la fonction ...
   env_function env

   let env = start_init_code in
